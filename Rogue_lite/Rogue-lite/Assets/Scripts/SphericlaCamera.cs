...
public class SphericlaCamera : MonoBehaviour
{
    ...
    public float maxnYAngle = 5.0f;                 // 최대 수직 각도
    ...
    private void HandleInput()
    {
        ...
        currentVerticalAngle = Mathf.Clamp(currentVerticalAngle, minYAngle, maxnYAngle);            // 최대 최소값으로 수직 이동을 닫는다.
    ...
    {
        // 구면 좌표계를 사용한 위치 계산
        float verticalAngleRadians = currentVerticalAngle * Mathf.Deg2Rad;              // 각도를 레디안으로 변환
